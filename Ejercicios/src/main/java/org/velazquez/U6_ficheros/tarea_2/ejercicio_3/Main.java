...
public class Main {
    public static void main(String[] args) {
        ...
        int num = sc.nextInt();
        try (DataOutputStream dos = new DataOutputStream(new FileOutputStream("C:\\Users\\Adria\\Programacion_23_24\\Ejercicios\\src\\main\\java\\org\\velazquez\\U6_ficheros\\tarea_2\\ejercicio_3\\archivo.bin"))){
            while (num>=0){
                dos.writeInt(num);
                System.out.println("Ingresa el siguiente numero que desea guardar (Numero negativo para terminar) :");
                num = sc.nextInt();
